            ...
            <div className='col-span-2'><img src='././image.png'/></div>
                <div className='container'>
                    ...
                    <div className="ml-4 mt-6 mb-2">
                        <button type="submit" className="bg-blue-800 w-80 py-2 rounded text-white text-md">Login</button>
                    </div>
                    ...
                    <GoogleLogin
                        ...
                        render={renderProps => (
                            <button className='bg-gray-400 w-48 py-2 rounded text-white text-md mt-2 ml-4' onClick={renderProps.onClick} disabled={renderProps.disabled}>Login with Google</button>
                        )}
